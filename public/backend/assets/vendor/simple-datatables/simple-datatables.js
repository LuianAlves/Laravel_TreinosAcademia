    ...
    return (function() {
        ...
        2: [function(require, module, exports) {
            ...
            const t = t => "[object Object]" === Object.prototype.toString.call(t),
                ...
                a = (t, s, a) => e("li", { class: t, html: `<a href="#" data-page="${s}">${a}</a>` }),
                i = (t, e) => {
                    let s, a;
            ...
            class h {
                ...
                order(t) {
                    ...
                    const l = [
                        ...
                        o = this.dt;
                    t.forEach(((t, a) => { n = o.headings[t], h = "false" !== n.getAttribute("data-sortable"), e = n.cloneNode(!0), e.originalCellIndex = a, e.sortable = h, l[0].push(e), o.hiddenColumns.includes(t) || (s = n.cloneNode(!0), s.originalCellIndex = a, s.sortable = h, l[1].push(s)) })), o.data.forEach(((e, s) => { a = e.cloneNode(!1), i = e.cloneNode(!1), a.dataIndex = i.dataIndex = s, null !== e.searchIndex && void 0 !== e.searchIndex && (a.searchIndex = i.searchIndex = e.searchIndex), t.forEach((t => { r = e.cells[t].cloneNode(!0), r.data = e.cells[t].data, a.appendChild(r), o.hiddenColumns.includes(t) || (r = e.cells[t].cloneNode(!0), r.data = e.cells[t].data, i.appendChild(r)) })), l[2].push(a), l[3].push(i) })), o.headings = l[0], o.activeHeadings = l[1], o.data = l[2], o.activeRows = l[3], o.update()
                }
                hide(t) {
                    if (t.length) {
                        const e = this.dt;
                ...
                sort(t, e, s) {
                    ...
                    if ("date" === c.getAttribute("data-type")) {
                        let t = !1;
                        c.hasAttribute("data-format") && (t = c.getAttribute("data-format")), p.push(Promise.resolve().then((function() { return require("./date-ee454f51.js") })).then((({ parseDate: e }) => s => e(s, t))))
                    }
                    Promise.all(p).then((n => {
                        ...
                        Array.from(h).forEach((e => {
                            const s = e.cells[t],
                                a = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                            let i;
                            i = p ? p(a) : "string" == typeof a ? a.replace(/(\$|,|\s|%)/g, "") : a, parseFloat(i) == i ? l[d++] = { value: Number(i), row: e } : r[o++] = { value: "string" == typeof a ? a.toLowerCase() : a, row: e }
                        ...
                        const f = [];
                        h.forEach(((t, e) => { a.data.push(t.row), null !== t.row.searchIndex && void 0 !== t.row.searchIndex && f.push(e) })), a.searchData = f, this.rebuild(), a.update(), s || a.emit("datatable.sort", t, e)
                    }))
                }
                rebuild() {
                    let t, e, s, a;
            ...
            class o {
                ...
                render(t) {
                    ...
                    if (s.data && r.call(this), this.body = this.dom.tBodies[0], this.head = this.dom.tHead, this.foot = this.dom.tFoot, this.body || (this.body = e("tbody"), this.dom.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = e("thead"),
                            a = e("tr");
                        this.hasRows && (Array.from(this.body.rows[0].cells).forEach((() => { a.appendChild(e("th")) })), t.appendChild(a)), this.head = t, this.dom.insertBefore(this.head, this.body), this.hiddenHeader = s.hiddenHeader
                    }
                ...
                renderPager() {
                    if (s(this.pagers), this.totalPages > 1) {
                        ...
                        })(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)), this.links[this.currentPage - 1].classList.add("active"), h.forEach((t => { t.classList.remove("active"), s.appendChild(t) })), this.links[this.currentPage - 1].classList.add("active"), this.options.nextPrev && !this.onLastPage && s.appendChild(a(t, n, this.options.nextText)), this.options.firstLast && s.appendChild(a(t, this.totalPages, this.options.lastText)), this.pagers.forEach((t => { t.appendChild(s.cloneNode(!0)) }))
                    }
                }
                renderHeader() {
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            if (this.options.scrollY.length && (s = e("thead"), s.appendChild(e("tr")), s.style.height = "0px", this.headerTable && (this.dom.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => { t.style.width = "" })), this.activeHeadings.forEach(((t, a) => {
                            ...
                            })), this.data.forEach((t => { Array.from(t.cells).forEach(((t, e) => { this.columns(t.cellIndex).visible() && (t.style.width = `${i[e]}%`) })) })), this.dom.removeChild(s)
                        }
                    }
                }
                    ...
                    return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = !0, this.searchData = [], t.length ? (this.clear(), this.data.forEach(((e, s) => {
                        ...
                        t.split(" ").reduce(((t, s) => {
                            ...
                            for (let t = 0; t < e.cells.length; t++)
                                if (i = e.cells[t], n = i.hasAttribute("data-content") ? i.getAttribute("data-content") : i.textContent, n.toLowerCase().includes(s) && this.columns(i.cellIndex).visible()) { a = !0; break }
                            return t && a
                    ...
                    if (a.data.length || t(a.data)) {
                        if ("csv" === a.type) {
                            ...
                            t.length && (a.headings && (s.headings = t[0].split(a.columnDelimiter), t.shift()), t.forEach(((t, e) => {
                                ...
                                i.length && i.forEach((t => { s.data[e].push(t) }))
                            })))
                        } else if ("json" === a.type) {
                            const e = (e => { let s = !1; try { s = JSON.parse(e) } catch (t) { return !1 } return !(null === s || !Array.isArray(s) && !t(s)) && s })(a.data);
                            e && (s = { headings: [], data: [] }, e.forEach(((t, e) => { s.data[e] = [], Object.entries(t).forEach((([t, a]) => { s.headings.includes(t) || s.headings.push(t), s.data[e].push(a) })) })))
                        }
                ...
                print() {
                    const t = this.activeHeadings,
                        ...
                        n = e("tbody"),
                        h = e("tr");
                    t.forEach((t => { h.appendChild(e("th", { html: t.textContent })) })), i.appendChild(h), s.forEach((t => {
                        const s = e("tr");

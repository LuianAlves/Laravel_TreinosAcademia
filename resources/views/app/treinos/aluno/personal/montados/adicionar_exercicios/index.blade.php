                ...
                <div class="col-lg-12">
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-between">
                                    <h4 class="card-title">Treinos do Aluno {{ strtoupper($treino->aluno->nome) }}</b>
                                    </h4>
                            ...
                            <div class="row justify-content-around mt-4">
                                ...
                                <div class="col-3">
                                    <a href="{{ route('adicionar.create', ['divisao' => 'treino_a', 'treino_id' => $treino->id]) }}"
                                        class="btn btn-sm" id="button-treinos">Treino A</a>
                                </div>

                                @if ($treino->divisao >= 2)
                                    <div class="col-3">
                                        <a href="{{ route('adicionar.create', ['divisao' => 'treino_b', 'treino_id' => $treino->id]) }}"
                                            class="btn btn-sm" id="button-treinos">Treino B</a>
                                    </div>
                                @endif

                                @if ($treino->divisao >= 3)
                                    <div class="col-3">
                                        <a href="{{ route('adicionar.create', ['divisao' => 'treino_c', 'treino_id' => $treino->id]) }}"
                                            class="btn btn-sm" id="button-treinos">Treino C</a>
                                    </div>
                                @endif

                                @if ($treino->divisao >= 4)
                                    <div class="col-3">
                                        <a href="{{ route('adicionar.create', ['divisao' => 'treino_d', 'treino_id' => $treino->id]) }}"
                                            class="btn btn-sm" id="button-treinos">Treino D</a>
                                    </div>
                                @endif
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row justify-content-between"
                                    style="font-size: 16px; font-family: 'Poppins', sans-serif; font-weight: 600; color: #6776f4;">
                                    <div class="col-6">
                                        <h5>Treino A</h5>
                                    </div>
                                </div>
                                            ...
                                            <tr class="row1" data-id="{{ $treino->id }}">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->serie }} x
                                                            <a href="#" id="edit_serie_a"
                                                                onclick="$('.serie_a').slideToggle(function(){$('#edit_serie_a')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->repeticao }}
                                                            <a href="#" id="edit_repeticao_a"
                                                                onclick="$('.repeticao_a').slideToggle(function(){$('#edit_repeticao_a')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <form
                                                    action="{{ route('adicionar.update', ['id' => $treino->id, 'exercicio_id' => $treino->exercicio_id]) }}"
                                                    method="post">
                                                    @csrf
                                                ...
                                                <td class="text-center">
                                                    <a
                                                        href="{{ route('adicionar.destroy', ['id' => $treino->id, 'exercicio_id' => $treino->exercicio_id]) }}"><i
                                                            class="bx bx-block fs-5 text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                            ...
                                            <tr class="row1" data-id="{{ $treino->id }}">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->serie }} x
                                                            <a href="#" id="edit_serie_b"
                                                                onclick="$('.serie_b').slideToggle(function(){$('#edit_serie_b')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->repeticao }}
                                                            <a href="#" id="edit_repeticao_b"
                                                                onclick="$('.repeticao_b').slideToggle(function(){$('#edit_repeticao_b')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr class="row1" data-id="{{ $treino->id }}">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->serie }} x
                                                            <a href="#" id="edit_serie_c"
                                                                onclick="$('.serie_c').slideToggle(function(){$('#edit_serie_c')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->repeticao }}
                                                            <a href="#" id="edit_repeticao_c"
                                                                onclick="$('.repeticao_c').slideToggle(function(){$('#edit_repeticao_c')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <form
                                                    ...
                                                    {{-- Editar Repetições --}}
                                                    <td class="repeticao_c text-center"
                                                        style="font-size: 18px; display: none;">
                                                        <div class="row">
                                                            <div class="d-flex justify-content-center">
                                                                <button type="submit" class="btn btn-sm btn-success"><i
                                            ...
                                            <tr class="row1" data-id="{{ $treino->id }}">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->serie }} x
                                                            <a href="#" id="edit_serie_d"
                                                                onclick="$('.serie_d').slideToggle(function(){$('#edit_serie_d')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="d-flex justify-content-around">
                                                            {{ $treino->repeticao }}
                                                            <a href="#" id="edit_repeticao_d"
                                                                onclick="$('.repeticao_d').slideToggle(function(){$('#edit_repeticao_d')});"><i
                                                                    class="bx bx-message-square-edit text-success fs-5"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <form
                                                    ...
                                                    {{-- Editar Repetições --}}
                                                    <td class="repeticao_d text-center"
                                                        style="font-size: 18px; display: none;">
                                                        <div class="row">
                                                            <div class="d-flex justify-content-center">
                                                                <button type="submit" class="btn btn-sm btn-success"><i

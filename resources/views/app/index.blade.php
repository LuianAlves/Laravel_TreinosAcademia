@php
    ...
    $pagamentos_pendentes = App\Models\Pagamentos\Pagamento::where('status', 0)->orderBy('data_pagamento_geral', 'ASC')->limit(4)->get();
                                    ...
                                    <tbody>
                                        @foreach($pagamentos_pendentes as $pgt)
                                            <tr>
                                                ...
                                                <td><b class="text-danger">R$ {{ $pgt->valor_pagamento_geral }}</b></td>
                                                <td>
                            ...
                            <div class="card-body pb-0">
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <a href="#"><img src="{{ asset('backend/assets/img/product-1.jpg') }}" alt=""></a>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a href="#"><img src="{{ asset('backend/assets/img/product-2.jpg') }}" alt=""></a>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a href="#"><img src="{{ asset('backend/assets/img/product-3.jpg') }}" alt=""></a>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a href="#"><img src="{{ asset('backend/assets/img/product-4.jpg') }}" alt=""></a>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <a href="#"><img src="{{ asset('backend/assets/img/product-5.jpg') }}" alt=""></a>
                                            </th>
